...
class _InactivePageContentState extends State<InactivePageContent> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: CustomText(text: AppLocalizations.of(context)!.offlineMode, fontSize: 18, fontWeight: FontWeight.bold),
        backgroundColor: Theme.of(context).colorScheme.surface,
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Icon(Icons.offline_bolt, size: 50.sp, color: Colors.red),
                ),
                ...
                CustomText(
                  text: AppLocalizations.of(context)!.goOnlineToStartReceivingOrders,
                ...
                SizedBox(
                  ...
                  child: CustomButton(
                    ...
                    onPressed: () {
                      context.read<DeliveryBoyStatusBloc>().add(const ToggleStatus(true));
                      context.pop();
                    },
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.trending_up, color: AppColors.primaryColor, size: 24.sp),
                            SizedBox(width: 12.w),
                            CustomText(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildInfoRow(
                          ...
                          state.profile!.deliveryBoy?.fullName ?? AppLocalizations.of(context)!.notSet,
                        ),
                        _buildInfoRow(
                          AppLocalizations.of(context)!.address,
                          state.profile!.deliveryBoy?.address ?? AppLocalizations.of(context)!.notSet,
                        ),
                        _buildInfoRow(
                          AppLocalizations.of(context)!.vehicleType,
                          state.profile!.deliveryBoy?.vehicleType ?? AppLocalizations.of(context)!.notSet,
                        ),
                        _buildInfoRow(
                          AppLocalizations.of(context)!.licenseNumber,
                          state.profile!.deliveryBoy?.driverLicenseNumber ?? AppLocalizations.of(context)!.notSet,
                        ),
                        _buildInfoRow(
                          AppLocalizations.of(context)!.status,
                          state.profile!.deliveryBoy?.status ?? AppLocalizations.of(context)!.notSet,
                        ),
                      ],
                    ),
                  ),
      ...
      LineChartData(
        gridData: FlGridData(
          ...
          getDrawingHorizontalLine: (value) {
            return FlLine(color: Theme.of(context).colorScheme.outline.withValues(alpha: 0.2), strokeWidth: 1.w);
          },
        ...
        lineBarsData: [
          LineChartBarData(
            ...
            gradient: LinearGradient(
              colors: [AppColors.primaryColor.withValues(alpha: 0.8), AppColors.primaryColor.withValues(alpha: 0.3)],
            ),
            barWidth: 3.w,
            ...
            belowBarData: BarAreaData(
              show: true,
              gradient: LinearGradient(
                colors: [AppColors.primaryColor.withValues(alpha: 0.3), AppColors.primaryColor.withValues(alpha: 0.1)],
  ...
  Widget _buildMonthlyChart() {
    return BarChart(
      BarChartData(
        ...
        barGroups: [
          BarChartGroupData(x: 0, barRods: [BarChartRodData(toY: 3200, color: AppColors.primaryColor)]),
          BarChartGroupData(x: 1, barRods: [BarChartRodData(toY: 2800, color: AppColors.primaryColor)]),
          BarChartGroupData(x: 2, barRods: [BarChartRodData(toY: 4200, color: AppColors.primaryColor)]),
          BarChartGroupData(x: 3, barRods: [BarChartRodData(toY: 3800, color: AppColors.primaryColor)]),
        ],
        gridData: FlGridData(
          show: true,
      ...
      PieChartData(
        ...
        sections: [
          PieChartSectionData(
            ...
            title: '35%',
            radius: 50,
            titleStyle: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.bold, color: Colors.white),
          ),
          PieChartSectionData(
            color: Colors.orange,
            value: 25,
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(child: CustomText(text: value, color: Theme.of(context).colorScheme.onSurface)),
        ],
      ),
    );
  }

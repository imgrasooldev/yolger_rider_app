...
class DialogService {
  ...
  static const Map<String, String> deliveryFailureReasonLabels = {
        ...
        return StatefulBuilder(
          builder: (context, setState) {
            Future<void> submit() async {
              ...
              final error = await onSubmit(controller.text.trim());
              ...
              child: AlertDialog(
                ...
                content: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text(
                        'If you cancel before collecting the items, this order will return to Ready for pickup so another rider can claim it.',
                      ),
                      SizedBox(height: 16.h),
                      TextFormField(
